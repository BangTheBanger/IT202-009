...
<ul>
    ...
    <ul>
        <li><a href="public_html/HW2/HW2-Problem1.php">HW 2 - Problem 1</a>
        <li><a href="public_html/HW2/HW2-Problem2.php">HW 2 - Problem 2</a>
        <li><a href="public_html/HW2/HW2-Problem3.php">HW 2 - Problem 3</a>
    </ul>
    <li><h3>Homework 3 - JS & CSS Challenge</h3>
    <ul>
